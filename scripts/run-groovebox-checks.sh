...
require_file "$REPO_ROOT/QUICKSTART.md"
require_file "$REPO_ROOT/CONTRIBUTING.md"
require_file "$REPO_ROOT/docs/learning/README.md"
require_file "$REPO_ROOT/docs/PUBLIC.md"
...
require_file "$REPO_ROOT/docs/GROOVEBOX_SONIC_SOUND_CATALOG.md"
require_file "$REPO_ROOT/docs/DISTRIBUTION.md"
...
require_file "$REPO_ROOT/config/groovebox-library.example.json"
